...
C.Races = {
    ...
    {
        id = "ogre", name = "Descendant du Colosse", rarity = "Fréquent",
        min = 4991, max = 5690,
    ...
    {
        id = "demiorc", name = "Descendant du Guerrier", rarity = "Fréquent",
        min = 5691, max = 6340,
    ...
    {
        id = "gobelin", name = "Descendant du Filou", rarity = "Fréquent",
        min = 6341, max = 6940,
    ...
    {
        id = "hommelezard", name = "Descendant du Rescapé", rarity = "Peu commun",
        min = 6941, max = 7490,
    ...
    {
        id = "hommerat", name = "Descendant de l'Ombre", rarity = "Peu commun",
        min = 7491, max = 7990,
    ...
    {
        id = "hommeloup", name = "Descendant du Chasseur", rarity = "Peu commun",
        min = 7991, max = 8440,
    ...
    {
        id = "hommechat", name = "Descendant de l'Acrobate", rarity = "Peu commun",
        min = 8441, max = 8840,
    ...
    {
        id = "gnome", name = "Descendant du Runiste", rarity = "Peu commun",
        min = 8841, max = 9240,
    ...
    {
        id = "hautelignee", name = "Haute Lignée", rarity = "Rare-ish",
        min = 9241, max = 9540,
    ...
    {
        id = "sangdragon", name = "Sang de Dragon", rarity = "Rare",
        min = 9841, max = 9990,
    ...
    {
        id = "sorcier", name = "Sang Arcanique", rarity = "Très rare",
        min = 9991, max = 10000,
