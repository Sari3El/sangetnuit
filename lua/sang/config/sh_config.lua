...
C.Races = {
    {
        id = "human", name = "Être Vivant", short = "Vivant", rarity = "Commun",
        min = 1, max = 3290,
        hp = 1.0, speed = 0.9, dmgReduction = 0.0,
        desc = "Aucune descendance particulière, la référence. Rien de plus.",
    },
    {
        id = "nain", name = "Descendant du Gardien", short = "Gardien", rarity = "Fréquent",
        min = 3291, max = 4190,
        hp = 1.15, speed = 0.75, dmgReduction = 0.15,
        desc = "Lignée de défenseurs. PV+, réduction de dégâts, mais lent.",
    },
    {
        id = "elfe", name = "Descendant de l'Archer", short = "Archer", rarity = "Fréquent",
        min = 4191, max = 4990,
        hp = 0.9, speed = 1.0, dmgReduction = 0.0,
        dmgBonus = { { tags = { "lightblade", "bow" }, mult = 1.20 } },
        desc = "Lignée de tireurs d'élite. Bonus dégâts arc / lame légère.",
    },
    {
        id = "ogre", name = "Descendant du Colosse", short = "Colosse", rarity = "Fréquent",
        min = 4991, max = 5690,
        hp = 1.2, speed = 0.7, dmgReduction = 0.20,
        dmgBonus = { { tags = { "ranged" }, mult = 0.80 } },
        desc = "Sang de titans. Gros PV + réduction, très lent, mauvais à distance.",
    },
    {
        id = "demiorc", name = "Descendant du Guerrier", short = "Guerrier", rarity = "Fréquent",
        min = 5691, max = 6340,
        hp = 1.1, speed = 0.85, dmgReduction = 0.0,
        dmgBonus = { { tags = { "heavymelee" }, mult = 1.20 } },
        desc = "Lignée de combattants. Bonus dégâts mêlée, un peu plus de PV.",
    },
    {
        id = "gobelin", name = "Descendant du Filou", short = "Filou", rarity = "Fréquent",
        min = 6341, max = 6940,
        hp = 0.85, speed = 1.05, dmgReduction = 0.0,
        dodge = 0.15,
        desc = "Lignée de voleurs. Rapide, chance d'esquive.",
    },
    {
        id = "hommelezard", name = "Descendant du Rescapé", short = "Rescapé", rarity = "Peu commun",
        min = 6941, max = 7490,
        hp = 1.1, speed = 0.9, dmgReduction = 0.10,
        regen = 2,
        desc = "Sang endurant. Régénération passive + légère réduction.",
    },
    {
        id = "hommerat", name = "Descendant de l'Ombre", short = "Ombre", rarity = "Peu commun",
        min = 7491, max = 7990,
        hp = 0.85, speed = 1.0, dmgReduction = 0.0,
        stealth = true,
        desc = "Lignée d'espions. Rapide et discret.",
    },
    {
        id = "hommeloup", name = "Descendant du Chasseur", short = "Chasseur", rarity = "Peu commun",
        min = 7991, max = 8440,
        hp = 0.95, speed = 1.0, dmgReduction = 0.0,
        dmgBonus = { { tags = { "melee" }, mult = 1.15 } },
        desc = "Lignée de traqueurs. Rapide + bonus dégâts mêlée.",
    },
    {
        id = "hommechat", name = "Descendant de l'Acrobate", short = "Acrobate", rarity = "Peu commun",
        min = 8441, max = 8840,
        hp = 0.8, speed = 1.1, dmgReduction = 0.0,
        dodge = 0.20,
        desc = "Lignée d'agiles. Le plus d'esquive, très rapide, fragile.",
    },
    {
        id = "gnome", name = "Descendant du Runiste", short = "Runiste", rarity = "Peu commun",
        min = 8841, max = 9240,
        hp = 0.85, speed = 0.9, dmgReduction = 0.0,
        magicResist = 0.5,
        desc = "Sang protégé par les runes. Résistance magique.",
    },
    {
        id = "hautelignee", name = "Haute Lignée", short = "Haute Lignée", rarity = "Rare-ish",
        min = 9241, max = 9540,
    ...
    {
        id = "hommeaigle", name = "Descendant du Ciel", short = "Ciel", rarity = "Rare-ish",
        min = 9541, max = 9840,
        hp = 0.8, speed = 1.15, dmgReduction = 0.0,
        weapons = { "sang_swep_vol" }, -- SWEP « Vol » (hors périmètre — à créer)
        desc = "Sang lié au ciel. Le plus rapide + SWEP Vol (à venir).",
    },
    {
        id = "sangdragon", name = "Sang de Dragon", short = "Draconique", rarity = "Rare",
        min = 9841, max = 9990,
        hp = 1.1, speed = 0.9, dmgReduction = 0.0,
        fireResist = 0.5,
        weapons = { "sang_swep_crachatfeu" }, -- SWEP « Crachat de feu » (hors périmètre)
        desc = "Descendance draconique. Résistance au feu + SWEP Crachat de feu (à venir).",
    },
    {
